...
const [withdrawError, setWithdrawError] = useState('');
  ...
  if (!withdrawMethod || !withdrawAddress.trim()) {
    setWithdrawError('Please select a withdraw method and provide address.');
    return;
  }
...
<div className="mb-6">
  ...
  <label className="block mb-2">Withdraw Method</label>
  <select
    ...
    className="w-full px-4 py-2 mb-3 bg-gray-700 border border-gray-600 rounded focus:outline-none"
  >
  ...
  <label className="block mb-2">Payment Address (UPI ID or Phone Number)</label>
  <input
    type="text"
  ...
  <input
    ...
    className="w-full px-4 py-2 mb-2 bg-gray-700 border border-gray-600 rounded focus:outline-none"
  />
